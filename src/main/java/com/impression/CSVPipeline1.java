...
public class CSVPipeline1 {
	...
	public static void main(String[] args) {
		...
		String BUCKET_NAME = "gs://client2_incoming/" + "Impressions*";

		
		//Pipeline p1 = Pipeline.create(options);
		//PCollection<String> wlines = p1.apply(TextIO.read().from(BUCKET_NAME));
	    //wlines.apply(TextIO.Write.named("WriteMyFile").to("gs://client2_outgoing"));      		
		...
		String BUCKET_CLICK = "gs://client2_incoming/" + "click*";
		...
		String BUCKET_ACTIVITY = "gs://client2_incoming/" + "activity*";
